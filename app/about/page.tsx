...
export const metadata: Metadata = {
  ...
  description: 'Learn about Bespoke By Pelican — our story, our craft, and our commitment to premium custom furniture in Bengaluru.',
};
      ...
      <main style={{ minHeight: '60vh', backgroundColor: '#F7F4EE', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '64px 32px' }}>
        <div style={{ textAlign: 'center', maxWidth: '600px' }}>
          ...
          <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: '15px', color: '#6B6560', lineHeight: 1.9, letterSpacing: '0.01em' }}>
            Our story is coming soon. In the meantime, feel free to{' '}
            <a href="/contact" style={{ color: '#C9A96E', textDecoration: 'none', borderBottom: '1px solid #C9A96E' }}>get in touch</a>
