...
const items: Item[] = [
  { src: '/slumbr1.jpeg',     name: 'Slumbr Sofa Cum Bed',  url: 'https://pelicanessentials.com/products/slumbr-sleeper-sofa-sofa-cum-bed-7-feet?_pos=1&_psq=slumbr&_ss=e&_v=1.0' },
  ...
  { src: '/anne3.jpeg',       name: 'Anne Sofa',             url: 'https://pelicanessentials.com/products/anne-sofa-3-seater-down-feather-cushion-7-feet-copy?_pos=2&_psq=anne+3&_ss=e&_v=1.0' },
